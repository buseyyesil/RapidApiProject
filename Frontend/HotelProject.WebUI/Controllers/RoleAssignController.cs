...
namespace HotelProject.WebUI.Controllers
{
    public class RoleAssignController : Controller
    {
        ...
        public async Task<IActionResult> AssignRole(int id)
        {
            ...
            List<RoleAssignViewModel> roleAssignViewModels = new List<RoleAssignViewModel>(); //buradaki liste RoleAssignViewModel sınfının içindeki propertleri tutuyor
            foreach (var item in roles) //bu döngü roller içerisindeki bütün rolleri tek tek bakacak aşağıdaki gibi
            {
                ...
                roleAssignViewModels.Add(roleAssignViewModel); //oluşturmuş olduğumuz listenin içine bu rolleri ekleyecek
            }
