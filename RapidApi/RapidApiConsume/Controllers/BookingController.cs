        ...
        public async Task<IActionResult> Index()
        {
            try
            {
                ...
                var request = new HttpRequestMessage
                {
                    ...
                    RequestUri = new Uri($"https://booking-com.p.rapidapi.com/v2/hotels/search?checkin_date={checkinDate}&checkout_date={checkoutDate}&filter_by_currency=TRY&dest_id=-1456928&room_number=1&units=metric&dest_type=city&locale=tr&adults_number=2&order_by=popularity&page_number=0&children_number=2&include_adjacency=true&children_ages=5%2C0&categories_filter_ids=class%3A%3A2%2Cclass%3A%3A4%2Cfree_cancellation%3A%3A1"),
                    Headers =
                    {
